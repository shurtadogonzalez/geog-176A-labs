...
covid = read_csv(url) 
head(covid)
#inserting the raw COVID data that is need for the lab 
...
# To get the number of daily new cases and the 7-day rolling mean of the California, New York, Florida, and Lousiana 
```{r}
...
#The number of daily, new cases at the state level can be misleading since it doesn't take into consideration the state's population. Once population is integrated into the number of cases, it is expect for data to reflect a more accurate representation of which out of the four states (CA, LA, NY, FL) has been affected more by CPVID. 
